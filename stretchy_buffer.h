...
#define sb_remove_swap stb_sb_remove_swap
#endif
...
static void stb__sbremf(void *arr, int index, int itemsize)
{
  ...
  void* initial = (void*) ((char*) arr) + (index+1)*itemsize;
  void* final = (void*) (((char*) initial) - itemsize);
  memmove(final, initial, itemsize * num_to_move);
}
